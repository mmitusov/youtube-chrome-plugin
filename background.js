//Логика благодаря которой наш браузер будет знать, что мы открыли новую вкладку
//Чтобы когда мы открыли нужную нам вкладку/страницу (в нашем случае Ютуб страницу), мы могли бы запустить наш скрипт для этой страницы
...
chrome.tabs.onUpdated.addListener((tabId, tab) => { //P.S. Мы можем повесить слушатель, так как в manifest.json мы дали доступ к chrome.tabs
  if (tab.url && tab.url.includes("youtube.com/watch")) { //Если у нас открыт tab.url и мы специфически открыли "youtube.com/watch"
